...
let
  ...
  CPANPerlReleases = buildPerlPackage rec {
    name = "CPAN-Perl-Releases-3.84";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/${name}.tar.gz";
      sha256 = "10q1vgsfk1y1aclr3wnbn2icwa9qcd2qfyvycp8dzh5hv520f8x5";
    };
    meta = {
...
#    buildInputs = [ TestPodLinkCheck ];
 ...
 JSONWebToken = buildPerlModule rec {
  ...
  ModuleCoreList = buildPerlPackage {
    name = "Module-CoreList-5.20181130";
    src = fetchurl {
      url = mirror://cpan/authors/id/B/BI/BINGOS/Module-CoreList-5.20181130.tar.gz;
      sha256 = "1izyjhrpwzvlshf7kmj43drwhj5jknh8nvs9j8d9qq889r9wcl5i";
    };
    meta = {
  ...
  Mojolicious = buildPerlPackage rec {
    name = "Mojolicious-8.09";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SR/SRI/${name}.tar.gz";
      sha256 = "1na0fvivl3rb3jvhnwzc56famnzlcb4sjl8z77qf32nrxaswk5jv";
    };
    meta = {
  ...
  RTClientREST = buildPerlModule {
    name = "RT-Client-REST-0.55";
    src = fetchurl {
      url = mirror://cpan/authors/id/D/DJ/DJZORT/RT-Client-REST-0.55.tar.gz;
      sha256 = "0a2c28a677b6186111a99afde3f56170a9dc1cf594359dfb1be50b494419daa2";
    };
