...
[
  ...
  (prevStage: rec {
    ...
    msblobs = import ../../../pkgs/development/compilers/msvc/msvc-2005-blobs.nix { stdenvNoCC = stdenv; };
...
#   };
    ...
    gnu-utils = let
      msysPacman  = import (../../development/mingw-modules/msys-pacman-i686.nix) {
                      stdenvNoCC = stdenv; # with 7z.exe
                      fetchurl = stdenv.fetchurlBoot;
                      inherit msysPacman mingwPacman;
                    };
      mingwPacman = import (../../development/mingw-modules/mingw-pacman-i686.nix) {
                      stdenvNoCC = stdenv; # with 7z.exe
                      fetchurl = stdenv.fetchurlBoot;
                      inherit msysPacman mingwPacman;
                    };
...
#   };
  ...
  (prevStage: {
    ...
    stdenv = import ../generic {
      ...
      cc = ( import ../../../pkgs/development/compilers/msvc/msvc-2005.nix {
