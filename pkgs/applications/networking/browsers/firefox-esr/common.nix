...
, autoconf213, which, gnused, rustPackages, rustPackages_1_37_0, llvmPackages
...
stdenv.mkDerivation (rec {
  ...
  ++ lib.optional (lib.versionOlder ffversion "60") libXdamage
  ++ lib.optional (lib.versionOlder ffversion "68") hunspell

  # >= 66 requires nasm for the AV1 lib dav1d
  # yasm can potentially be removed in future versions
  # https://bugzilla.mozilla.org/show_bug.cgi?id=1501796
  # https://groups.google.com/forum/#!msg/mozilla.dev.platform/o-8levmLU80/SM_zQvfzCQAJ
  ++ lib.optional (lib.versionAtLeast ffversion "68") nasm
  ...
  NIX_CFLAGS_COMPILE = toString ([
    ...
    ] ++ lib.optionals (lib.versionAtLeast ffversion "60" /*&& lib.versionOlder ffversion "69"*/) [
      "-Wno-error=format-security"
    ]);

  postPatch = lib.optionalString (lib.versionAtLeast ffversion "68" && !isTorBrowserLike) ''
  ...
  nativeBuildInputs =
    ...
    ++ (if lib.versionOlder ffversion "60" then [
        ] else if lib.versionOlder ffversion "68" then [
          rustPackages_1_37_0.rustc rustPackages_1_37_0.cargo
        ] else [
          rustPackages.rustc rustPackages.cargo rust-cbindgen
          python3 nodejs
          llvmPackages.llvm  # llvm-objdump is required in version >=67.0
        ]);
  ...
  preConfigure = ''
    ...
    rm -f .mozconfig*
  '' + (if lib.versionAtLeast ffversion "60"
  ...
  '') + lib.optionalString (lib.versionAtLeast ffversion "60") ''
  ...
  '' + lib.optionalString googleAPISupport ''
    ...
    ${if lib.versionAtLeast ffversion "60" then ''
    ...
    ''}
  '' + lib.optionalString (lib.versionOlder ffversion "60") ''
    cd obj-*
  ''
  ...
  ++ lib.optional (lib.versionOlder ffversion "68") "--disable-maintenance-service"
  ++ lib.optional (stdenv.isDarwin && lib.versionAtLeast ffversion "68") "--disable-xcode-checks"
  ++ lib.optional (lib.versionOlder ffversion "68") "--enable-system-hunspell"
  ++ lib.optionals (lib.versionAtLeast ffversion "60") [
  ...
  postConfigure = lib.optionalString (lib.versionAtLeast ffversion "60") ''
    cd obj-*
  '';
  ...
  RUSTFLAGS = lib.optionalString (lib.versionOlder ffversion "68") "--cap-lints warn";
